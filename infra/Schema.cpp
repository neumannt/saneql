...
// Create the TPC-H schema for experiments
{
   ...
   createTable("supplier", {{"s_suppkey", Type::getInteger()}, {"s_name", Type::getChar(25)}, {"s_address", Type::getVarchar(40)}, {"s_nationkey", Type::getInteger()}, {"s_phone", Type::getChar(15)}, {"s_acctbal", Type::getDecimal(12, 2)}, {"s_command", Type::getVarchar(101)}});
